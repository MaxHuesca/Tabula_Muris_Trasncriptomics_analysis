---
title: "Download and data preproccesing"
...
wget https://ftp.ncbi.nlm.nih.gov/geo/series/GSE132nnn/GSE132040/suppl/GSE132040%5FMACA%5FBulk%5Fmetadata.csv.gz -O data/Tabula_Muris_GSE_metadata.csv.gz 
...
print(f"The columns that are present in the metadata are {list(metadata_GSE.columns)}")
...
print(f"So the SRR ids are {SRR_boneM}")
```
